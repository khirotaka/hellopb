...
type ProductCommandClient interface {
	...
	Delete(ctx context.Context, in *ProductUpResult, opts ...grpc.CallOption) (*ProductUpResult, error)
}
...
func (c *productCommandClient) Delete(ctx context.Context, in *ProductUpResult, opts ...grpc.CallOption) (*ProductUpResult, error) {
	out := new(ProductUpResult)
...
type ProductCommandServer interface {
	...
	Delete(context.Context, *ProductUpResult) (*ProductUpResult, error)
...
func (UnimplementedProductCommandServer) Delete(context.Context, *ProductUpResult) (*ProductUpResult, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Delete not implemented")
}
...
func _ProductCommand_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductCommandServer).Delete(ctx, req.(*ProductUpResult))
	}
	return interceptor(ctx, in, info, handler)
}
